        ...
        for p=1:7
            ...
            for directioni=1:4
                if t==0 && directioni>1
                    ...
                    stimType(imgsCount,1:5)=[rim,t,edg_x,edg_y,directioni]; % rim size(0 or 40), chupchik size, pos x, pos y, direction
                    if rim==0 && t==0
