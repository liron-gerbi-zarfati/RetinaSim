function experiment3(CPD,bulge_deg,step,detections,rim_col,msg)
if ~exist('CPD','var')
    CPD=[];
end
if isempty(CPD)
...
step=1/10.^(step/10); % dB to ratio

if ~exist('detections','var')
    detections=[]; % how many detections to declare threshold
end
if isempty(detections)
    detections=3;
end
if ~exist('rim_col','var')
    rim_col=[];
end
if isempty(rim_col)
    rim_col= 0.5;
