...
% txt=rgb2gray(imread(('\\madrid.eng.biu.ac.il\enggrad\abrahah3\Desktop\�������\����_������/Alice101.png')));
txt=imread(('./alice100.png'));
...
%      initialize the parameters   
    ...
    if xinit-pix<1            
            ...
            if zoom_flag %meaning I'm in zoom mode
                ...
                mov_index_x1=mov_index_x1-10*r;
                a=1;
        ...
        elseif a==1
            if zoom_flag
                xinit_txt2=xinit_txt;
                mov_index_x1=mov_index_x1+10*r;
                xinit_txt=floor(xinit*Zoom_factor^r);
                xinit_txt=max(xinit_txt+mov_index_x1+pix,pix+1);
                if xinit_txt2<xinit_txt
                    xinit_txt=max(floor(xinit*Zoom_factor^r)+mov_index_x1-pix,pix+1);
                end
    ...
    if yinit-pix<1
            ...
            if zoom_flag %meaning I'm in zoom mode
                ...
                mov_index_y1=mov_index_y1-10*r;
                b=1;
            else %not in zoom mode
                yinit_txt=floor(yinit*Zoom_factor^r);
            end
        elseif b==1
            if zoom_flag
                yinit_txt2=yinit_txt;
                mov_index_y1=mov_index_y1+10*r;
                yinit_txt=floor(yinit*Zoom_factor^r);
                yinit_txt=max(yinit_txt+mov_index_y1+pix,pix+1);
                if yinit_txt2<yinit_txt
                    yinit_txt=max(floor(yinit*Zoom_factor^r)+mov_index_y1-pix,pix+1);
                end
        ...
        if xinit+pix>size(background,2)            
            ...
            if zoom_flag %meaning I'm in zoom mode
                ...
                mov_index_x2=mov_index_x2+10*r;
                c=1;
            else %not in zoom mode
                xinit_txt=floor(xinit*Zoom_factor^r);
            end
...
%                 mov_index_x2=max(mov_index_x2-8*r,0);
        ...
        if yinit+pix>size(background,1)            
            ...
            if zoom_flag %meaning I'm in zoom mode
                ...
                mov_index_y2=mov_index_y2+10*r;
                d=1;
            else %not in zoom mode
                yinit_txt=floor(yinit*Zoom_factor^r);
            end
